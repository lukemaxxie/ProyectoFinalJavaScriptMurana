...
const servicio1= new Servicio ("Tortas personalizadas", 150, 125);
const servicio2= new Servicio ("Servicio de Lunch", 180, 150);
const servicio3= new Servicio ("Mesa dulce", 310, 290);

/* ---- ARRAYS ----*/
const pedidos = [{usuario:"",producto:1,cantidad:10,total:7500},{usuario:"",producto:3,cantidad:50,total:20000},{usuario:"",producto:2,cantidad:25,total:10000}];
